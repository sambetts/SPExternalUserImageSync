...
namespace SPOUtils
{
    public class AuthUtils
    {
        ...
        public static async Task<ClientContext> GetClientContext(CSOMConfig config, string siteUrl, DebugTracer tracer)
        {
        ...
        public static async Task<IConfidentialClientApplication> GetNewClientApp(CSOMConfig config)
        {
